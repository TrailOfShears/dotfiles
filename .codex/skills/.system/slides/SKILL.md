...
When referring to bundled files in this skill, use paths relative to `.codex\skills`, such as `.system/slides/references/presentation.md`.
...
- [`.system/slides/references/presentation.md`](../slides/references/presentation.md) for the core `Presentation` and `PresentationFile` lifecycle.
- [`.system/slides/references/auto-layout.md`](../slides/references/auto-layout.md) for deterministic layout helpers and alignment enums.
