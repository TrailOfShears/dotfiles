...
When referring to bundled files in this skill, use paths relative to `.codex\skills`, such as `.system/spreadsheets/references/workbook.md`.
...
- [`.system/spreadsheets/references/workbook.md`](../spreadsheets/references/workbook.md) for workbook lifecycle and worksheet basics.
- [`.system/spreadsheets/references/ranges.md`](../spreadsheets/references/ranges.md) for A1 addressing, values, formulas, and formatting.
